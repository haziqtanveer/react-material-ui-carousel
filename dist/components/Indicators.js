...
var Indicators = function (props) {
    ...
    var _loop_1 = function (i) {
        ...
        var createIndicator = function (IndicatorIcon) {
            return (react_1.default.createElement(Styled_1.StyledIndicatorIconButton, __assign({ "$active": i === props.active, key: i, className: className, style: style, onClick: function () { props.press(i); } }, restProps, { "aria-label": "".concat(restProps['aria-label'], " ").concat(i + 1) }), IndicatorIcon));
        };
